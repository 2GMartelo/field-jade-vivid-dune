...
import { t as isAllowedMediaUrl } from "./hosts-C3nIU59c.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CjzHg3uZ.js
var router_CjzHg3uZ_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-HUaP1PCE.css";
var APP_NAME = "Kadr";
...
var $$splitComponentImporter = () => import("./routes-B6VgXTI6.mjs");
...
var Route = createFileRoute("/api/media")({ server: { handlers: { GET: async ({ request }) => {
	...
	if (!target) return new Response("forbidden", { status: 400 });
	const headers = {
		"User-Agent": UA,
		Accept: "image/*,video/*,*/*"
	};
...
//#endregion
export { getRouter, router_CjzHg3uZ_exports as t };
