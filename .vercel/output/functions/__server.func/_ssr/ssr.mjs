...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D-kIe3O_.mjs");
...
var manifest = {
	"5c7432d625eba5e95cc2ae9ad210ab2c39703573490505556af09f7cf7123d60": {
		functionName: "searchPosts_createServerFn_handler",
		importer: () => import("./search-BMzCNKKU.mjs")
	},
	"7c3dcd6431faf2cfc04406099a02d8f5c5e716f8b9b84bad913e6a0e4ea01ac3": {
		functionName: "suggestTags_createServerFn_handler",
		importer: () => import("./search-BMzCNKKU.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CjzHg3uZ.mjs").then((n) => n.t),
